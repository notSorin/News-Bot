...
public class AgentsEnums
{
	...
	public enum MessageValue
	{
		...
		RESPONSE_EXTRACT_FROM_ARTICLE, GET_EXTRACTED_PERSON, GET_EXTRACTED_DATE,
		GET_EXTRACTED_LOCATION, GET_EXTRACTED_ORGANIZATION, GET_EXTRACTED_MONEY,
		GET_EXTRACTED_PERCENT
	}
}